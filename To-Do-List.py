...
class todo:
    def __init__(self,root):
        ...
        self.label1=Label(self.root,text="TO-DO-LIST",font=("ariel",25,"bold"), width=10,bd=5,bg="orange",fg="black")
        ...
        self.button2=Button(self.root,text="DELETE",font=("ariel",18,"italic bold"),width=10,bd=5,bg="yellow",fg="black",command=delete)              
